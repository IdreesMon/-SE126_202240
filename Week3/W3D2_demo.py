...
#cvombines all of the oarallel 1Ds - shorter, more efficient 
text_file_list = []
...
with open("Week3/lab2b.csv") as csvfile:
    ...
    for rec in file:
        ...
        #text_file_list.append([D,'DL', 'i5', '08', '001TB', '1',)
...
for i in range (0,len(text_file_list)):
    ...
    for x in range(0, len(text_file_list[1])):
