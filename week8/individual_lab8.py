#Idrees M Abdurrazzak, Dylan Fisher, Latoya Hall
#SE126.10 Intermediate Prog Using Python
#03/01/2024
#prompt: Write a Python program to assign passengers seats in an airplane.  Assume a small airplane with seat numbering as follows.

#variable dictionary: 
#seats: 2d array that holds the seat placement
#selectSeat: function that allows user to select seat placement
#printSeats: function that prints the 2d array of seats
#seatRow: integer that holds the row of the seat
#seatLetter: string that holds the letter of the seat
#letterDictionary: dictionary that holds the letter of the seat and its index
#selectedSeat: string that holds the seat that the user has selected
