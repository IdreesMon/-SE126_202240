...
with open ("week5_demo1/listPractice1.txt") as csvfile:
    file = csv.reader(csvfile)

    for record in file:
        lname.append: (record[0])
        fname.append: (record[1])
...
#show user menu, store chocice into a var, use the var for the loop 
menu_choice = menu()
...
while menu_choice != 4: #4 means exit
    ...
    if menu_choice == 1:
        ...
        found = seq_search(search)#seq_search(search)
    ...
    #give user opportunity to see menu/reselct, or exit 
