...
#PROMPT: produce a report that lists all the computers in the csv file lab2b.csv. Your report should look like the following sample output. The last line should print the number of computers in the file.

#-------Variable Dictionary---------
#average: The average Hard Drive size
#desktop_count: The amount of Desktops 
#total_records: The amount of total records on file
#file: Variable name for CSV reader
#total_size: Hard Drive total size
#count_size:
#comp_type_list: List of computer types
#manu_list: List of manufactuer types
#processor_list: List of processor
#ram_list: List of available ram for each comp
#hdd_1_list: List of computers with one Hard Drive 
#num_hdd_list: 
#hdd_2_list: List of computers with two Hard Drives
#os_list: Operating systems 
#year_list: List of different computer years
